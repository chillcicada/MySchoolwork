...
馏出液的流量为 $D = 45.455 "kmol/h"$，组成为 $x_D = 0.95$。

（2）精馏段的操作线方程：

$
  y_n &= R / (R + 1) x_(n+1) + 1 / (R + 1) x_D \
  y_n &= 5 / 7 x_(n+1) + 2 / 7 x_D
$
...
$
  L' = L + q F = R D + q F = 2.5 times 45.455 + 1 times 100 "koml/h" = 213.64 "kmol/h"
$
...
$
  ...
  => x_n = y_n / (alpha - (alpha - 1) y_n)
$

*从上往下计算*，$y_1 = x_D = 0.95$，有：

$
  x_1 &= 0.95 / (1.6 - 0.6 times 0.95) = 0.922 \
  y_2 &= 2 / 3 times 0.922 + 1 / 3 times 0.95 = 0.931
$

即塔内由上向下数第二块理论板的上升气相组成为 $y_2 = 0.931$。

（2）由题意得：

$
  L &= R D = 2 times 50 "kmol/h" = 100 "kmol/h" \
  V &= L + D = 150 "kmol/h"
$
