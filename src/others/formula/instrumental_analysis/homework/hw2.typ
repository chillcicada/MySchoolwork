...
#figure(image("hw2/first_output.png", width: 60%), caption: "初次拟合图像")
...
则 $w_("乙烯") = 85.38%$，由 $M_r("乙烯") = 28$ 得乙酸乙烯酯的摩尔分数为：

$
  x_("乙酸乙烯酯") = (w_("乙酸乙烯酯") \/ M_r ("乙酸乙烯酯")) / (w_("乙酸乙烯酯") \/ M_r ("乙酸乙烯酯") + w_("乙烯") \/ M_r ("乙烯")) times 100% = 5.28%
$
